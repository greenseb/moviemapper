...
export default function Map({ currentUser }): JSX.Element {
  const pinURL: string = process.env.REACT_APP_API as string;
  ...
  const [currentPinId, setCurrentPinId] = useState<any>(null);
  ...
  const handlePopupClick = (id: number, lat, long) => {
    setCurrentPinId(id);
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.post(pinURL, newEntry);
